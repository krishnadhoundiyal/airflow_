...
# Define the DAG
dag = DAG(dag_id="workflow_3", default_args=default_args, schedule_interval="13 01 * * 1,2,6", catchup=False)
...
branch_task = BranchPythonOperator(
    ...
    op_kwargs={ 'dag_id': "workflow_3", 'task_id': "python_task" },
    provide_context=True,
    dag=dag
)
